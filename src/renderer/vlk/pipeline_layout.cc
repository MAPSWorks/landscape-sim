...
PipelineLayout::PipelineLayout(const VkDevice& device, const VkPipelineLayoutCreateInfo &create_info) :
    device_(device),
    pipeline_layout_(Create(create_info)) {
...
VkPipelineLayout PipelineLayout::Create(const VkPipelineLayoutCreateInfo &create_info) const {
    VkPipelineLayout pipeline_layout;
    ErrorCheck(vkCreatePipelineLayout(device_, &create_info, nullptr, &pipeline_layout));
